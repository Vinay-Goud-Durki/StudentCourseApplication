...
document.getElementById("signinForm").addEventListener("submit", function (e) {
  ...
  localStorage.setItem("adminData", JSON.stringify(data.data)); // store only admin info
...
.catch(async (error) => {
  let errorMsg = "❌ Login failedlll. Please try again.";
  ...
  try {
    ...
    if (error?.response?.data) {
      ...
      if (errorMsg.toLowerCase().includes("email")) {
        ...
        errorMsg = "❌ Login failedjjj: " + errorMsg;
      }
    }
  } catch (e) {
